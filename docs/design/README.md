...
| [Handshake state foundation](v2-handshake-foundation.md) | Bounded authenticated attempts, pre-CHALLENGE credits, retry/cancellation ownership and first-winner Carrier selection; runtime integration pending |
