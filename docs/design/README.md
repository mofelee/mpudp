...
The initial protocol/wire selection parser, handshake codec and logical FEC
group codec have landed as isolated increments. CI runs their unit/race tests,
bounded fuzz smoke and independent handshake-vector regeneration. Complete
configuration and contract selection, replay/ownership/cancellation state,
runtime integration, measured performance/latency and the remaining platform
